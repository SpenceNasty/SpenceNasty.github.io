...
<meta property="og:image" content="https://bitcoin.org/img/icons/opengraph.png?1565622363" />
...
<link rel="stylesheet" href="/css/main.css?1565622363">
<!--[if lt IE 8]><link rel="stylesheet" href="/css/ie.css"><script type="text/javascript" src="/js/ie.js"></script><![endif]-->
<!--[if IE 8]><link rel="stylesheet" href="/css/ie8.css"><![endif]-->


<script type="text/javascript" src="/js/base.js?1565622363"></script>
<script type="text/javascript" src="/js/main.js?1565622363"></script>
<script src="/js/jquery/jquery-1.11.2.min.js"></script>
<script src="/js/jquery/jquery-ui.min.js"></script>
<script src="/js/jquery/jquery.qrcode.min.js"></script>
<link rel="shortcut icon" href="/favicon.png?1565622363">
<link rel="apple-touch-icon-precomposed" href="/img/icons/logo_ios.png?1565622363"/>
<script>
    window.cookieconsent_options = {
        theme: 'light-floating'
    }
</script>
<script type="text/javascript" src="/js/cookieconsent/cookieconsent.js?1565622363"></script>
<script>
  ...
  <div class="modal-dialog">
    ...
    <div>
      <a
        ...
        href="bitcoin:3FkenCiXpSLqD8L79intRNXUgjRoH9sjXa"
        target="_blank">
...
<a class="logo" href="/en/"><img src="/img/icons/logotop.svg?1565622363" alt="Bitcoin"></a>
...
<div class="row hero-social">
  <a href="" onclick="window.open('http://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent(location.href))" class="hero-social-link" target="_blank">
    <img src="/img/icons/ico_facebook_bright.svg?1565622363" alt="facebook">
  </a>
  <a href="" onclick="window.open('https://twitter.com/share?url=' + encodeURIComponent(location.href))" class="hero-social-link" target="_blank">
    <img src="/img/icons/ico_twitter_bright.svg?1565622363" alt="twitter">
  </a>
</div>
  </div>
</div>
<div class="mainoverview">
  <div class="container">
    ...
    <a href="/en/bitcoin-for-individuals" class="maincard">
      <img class="maincard-img" src="/img/icons/ico_individuals.svg?1565622363" alt="Icon">
      <div>
    ...
    <a href="/en/bitcoin-for-businesses" class="maincard">
      <img class="maincard-img" src="/img/icons/ico_business.svg?1565622363" alt="Icon">
      <div>
        <p class="maincard-title">Businesses</p>
        <p class="maincard-link">Learn more</p>
      </div>
    </a>
    <a href="/en/bitcoin-for-developers" class="maincard">
      <img class="maincard-img" src="/img/icons/ico_developers.svg?1565622363" alt="Icon">
      <div>
  ...
  <a class="btn-down" href="#maindesc-title">
    <img src="/img/icons/ico_arrow_down.svg?1565622363" alt="Link">
  </a>
</div>
<div class="maindesc">
  <div class="container">
      ...
      <div>
        ...
        <ul class="mainlist">
            ...
            <li class="mainlist-item">
              <img src="/img/icons/main_ico_instant.svg?1565622363" alt="Icon">
              <p>Fast peer-to-peer transactions</p>
            </li>
          
          
            <li class="mainlist-item">
              <img src="/img/icons/main_ico_worldwide.svg?1565622363" alt="Icon">
              <p>Worldwide payments</p>
            </li>
          
          
            <li class="mainlist-item">
              <img src="/img/icons/main_ico_lowfee.svg?1565622363" alt="Icon">
              <p>Low processing fees</p>
            </li>
          
        </ul>
      </div>
      <img class="maindesc-img" src="/img/home/bitcoin-img.svg?1565622363" alt="Bitcoin image">
    </div>
    <div class="btn-container">
...
<a class="logo-footer" href="/en/">
  <img src="/img/icons/logo-footer.svg?1565622363" alt="Bitcoin">
</a> 
  ...
  <div class="donate">
    <div class="row donate-row">
      <div>
        ...
        <p class="donate-text">
          <a class="donate-link" href="bitcoin:3FkenCiXpSLqD8L79intRNXUgjRoH9sjXa" target="_blank">3FkenCiXpSLqD8L79intRNXUgjRoH9sjXa</a>
        </p>
      </div>
      <div class="donate-qrcode">
        <img src="/img/footer/qr.png?1565622363" alt="QR code">
      </div>
    </div>
  </div>
...
<div class="footersponsor">
  <!--<div><span>A community website sponsored by</span> <a href="https://bitcoinfoundation.org/"><img src="/img/brand/bitcoinfoundation.png?1565622363" alt="Bitcoin Foundation"></a></div>-->
</div>
...
<div class="footer-bottom">
  <div class="container">
    <div class="row footer-bottom-row">
      <div class="footerlicense">© Bitcoin Project 2009-2019 Released under the <a href="http://opensource.org/licenses/mit-license.php" target="_blank">MIT license</a></div>
      <div class="row footer-social">
        <a href="" onclick="window.open('http://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent(location.href))" class="footer-social-link" target="_blank">
          <img src="/img/icons/ico_facebook_dark.svg?1565622363" alt="facebook" class="footer-social-img">
        </a>
        <a href="" onclick="window.open('https://twitter.com/share?url=' + encodeURIComponent(location.href))" class="footer-social-link" target="_blank">
          <img src="/img/icons/ico_twitter_dark.svg?1565622363" alt="twitter" class="footer-social-img">
        </a>
      </div>
